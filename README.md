...
**User Stories:**
- [x] `input` element with `id="number"`
- [x] `button` element with `id="convert-btn"`
- [x] `div`, `span`, or `p` element with `id="output"`
- [x] Empty input → `"Please enter a valid number"`
- [x] Number < 1 → `"Please enter a number greater than or equal to 1"`
- [x] Number ≥ 4000 → `"Please enter a number less than or equal to 3999"`
- [x] `9` → `"IX"`
- [x] `16` → `"XVI"`
- [x] `649` → `"DCXLIX"`
- [x] `1023` → `"MXXIII"`
